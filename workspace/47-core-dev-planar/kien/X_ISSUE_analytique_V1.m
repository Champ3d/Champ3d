...
turnt11 = OxyTurnT00b("center",[0 0],"dir",0,"ri",ri,"ro",ro,"rwire",wcoil,"z",0,"openi",180,"openo",180,"pole",+1);
% ---
turnt21 = turnt11';
turnt21.rotate(180);
turnt21.pole = -1;
...
tplot.getflux;
tplot.plot; hold on
f_quiver(tplot.dom.interior.node,tplot.A);


figure
tplot = turnt11;
tplot.getflux('turn_obj',turnt21);
tplot.plot; hold on
f_quiver(turnt21.dom.mean.node,tplot.A);
