...
% turn12 = OxyTurnT00b("center",[0 0],"dir",180,"ri",ri,"ro",ro,"rwire",wcoil,"z",0,"openi",180,"openo",180,"pole",+1);
turn12 = turn11'; turn12.rotate(180); turn12.pole = +1;
% --- top coil
turn21 = turn11'; turn21.translate([0 0 agap + 2*wcoil]);
turn22 = turn12'; turn22.translate([0 0 agap + 2*wcoil]);
% ---
coil1 = OxyCoil4("I",I1,"imagelevel",1);
...
%coil1.setup;
% ---
coil2 = OxyCoil4("I",I2,"imagelevel",1);
coil2.add_turn(turn21);
coil2.add_turn(turn22);
