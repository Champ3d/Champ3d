...
param_00 = 1e6;
param_01 = Parameter('parent_model',model01,'f',@(x)(x + 1),'depend_on','T','from',model01);
param_02 = Parameter('parent_model',model01,'f',@(x)(x + 1),'depend_on','T','from',model02);
param_04 = Parameter('parent_model',model01,'f',@(x)(x + 1),'depend_on','T','from',model03);
param_07 = Parameter('parent_model',model01,'f',@(x)(x + 1),'depend_on','T','from',model04);
param_13 = Parameter('parent_model',model01,'f',@(x)(x + 1),'depend_on','T','from',model05);
% ---
param_03 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','B'},'from',{model01,model02});
param_05 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','B'},'from',{model03,model03});
param_09 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','B'},'from',{model03,model04});
param_15 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','B'},'from',{model03,model05});
% ---
param_06 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','E'},'from',{model03,model02});
param_10 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','E'},'from',{model01,model04});
param_16 = Parameter('parent_model',model01,'f',@(x,y)(x + norm(y)),...
           'depend_on',{'T','E'},'from',{model01,model05});
% ---
param_11 = Parameter('parent_model',model01,'f',@(x)(x),'depend_on','E','from',model01);
param_12 = Parameter('parent_model',model01,'f',@(x)(x),'depend_on','E','from',model04);
% ---
param_08 = Parameter('parent_model',model01,'f',@(x)(x),'depend_on','B','from',model04);
param_14 = Parameter('parent_model',model01,'f',@(x)(x),'depend_on','B','from',model05);

% --- Able to customized complex dependency
param_17 = Parameter('parent_model',model01,'f',@f__customized,'depend_on','celem','from',model01,...
                     'fvectorized',0,...
