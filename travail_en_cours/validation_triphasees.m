...
% --- Coil
Coil11 = SArcRectangle("id","fil_out1","center",[0 0],"ri",ri,"ro",ro,"openi",120-epsilon,"openo",120-epsilon,...
                         "orientation",0,"dnum",dnum,"choosed_by","top");

Coil12 = SArcRectangle("id","fil_in1","center",[wcoil 0],"ri",ri,"ro",ro-2*wcoil,"openi",120-epsilon,"openo",120-epsilon,...
                         "orientation",0,"dnum",dnum,"choosed_by","top");


Coil21 = SArcRectangle("id","fil_out2","center",[0 0],"ri",ri,"ro",ro,"openi",120-epsilon,"openo",120-epsilon,...
                         "orientation",120,"dnum",dnum,"choosed_by","top");

Coil22 = SArcRectangle("id","fil_in2","center",[wcoil 0],"ri",ri,"ro",ro-2*wcoil,"openi",120-epsilon,"openo",120-epsilon,...
                         "orientation",120,"dnum",dnum,"choosed_by","top");



Coil31 = SArcRectangle("id","fil_out3","center",[0 0],"ri",ri,"ro",ro,"openi",120-epsilon,"openo",120-epsilon,...
                         "orientation",240,"dnum",dnum,"choosed_by","top");

Coil32 = SArcRectangle("id","fil_in3","center",[wcoil 0],"ri",ri,"ro",ro-2*wcoil,"openi",120-epsilon,"openo",120-epsilon,...
                         "orientation",240,"dnum",dnum,"choosed_by","top");
