function dgeo = f_make_dom2d(varargin)
% 1. rectangle domain
% Without rotation around 'center' by an angle 'a'
%      => 'wid' = length along x, 'hei' = length along y
% dom2D = f_make_dom2D('shape','rec','wid',w,'hei',h,'center',[x y],'angle',a);
% dom2D = f_make_dom2D('shape','rec','wid',w,'hei',h);
% dom2D = f_make_dom2D('shape','rec','wid',w,'hei',h,'cbase',[x y],'angle',a);
% dom2D = f_make_dom2D('shape','rec','wid',w,'hei',h,'lbase',[x y],'angle',a);
% dom2D = f_make_dom2D('shape','rec','wid',w,'hei',h,'rbase',[x y],'angle',a);
%
% 2. circular domain
% dom2D = f_make_dom2D('shape','cir','radius',r,'center',[x y]);
% d3 = f_make_dom2D('shape','cir','radius',1,'center',[0 1]);
% 3. elliptical domain
% dom2D = f_make_dom2D('shape','ell','xradius',xr,'yradius',yr,'center',[x y],'angle',a);
% d4 = f_make_dom2D('shape','ell','xradius',2,'yradius',0.5,'center',[0 2],'angle',0);
%--------------------------------------------------------------------------
% CHAMP3D PROJECT
