...
%% line1d
msize = 1;
xline.xair_l = chfactory.line1d('len',x_abox ,'dnum',2*msize,'dtype','log-');
xline.xplate = chfactory.line1d('len',x_plate,'dnum',msize,'dtype','log+-');
xline.xair_r = chfactory.line1d('len',x_abox ,'dnum',2*msize,'dtype','log+');
% ---
yline.yair_b = chfactory.line1d('len',x_abox,'dnum',5*msize,'dtype','log-');
yline.yplate = [];
for i = 1:2
    idyl = ['yplate' num2str(i)];
    yline.(idyl) = chfactory.line1d('len',l_plate,'dnum',5*msize,'dtype','lin');
end
% ---
yline.yair_t = chfactory.line1d('id','yair_t','len',x_abox ,'dnum',5*msize,'dtype','log+');

%% mesh2d-quad
quadmesh = chfactory.mesh2d('mesh_type','quad_mesh_from_1d',...
                            'xline',[xline.xair_l xline.xplate xline.xair_r],...
                            'yline',[yline.yair_b yline.yplate yair_t]);
